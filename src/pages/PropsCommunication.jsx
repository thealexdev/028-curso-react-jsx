        ...
        <div className="min-h-screen bg-stone-100 text-slate-900">
            ...
            <main className="mx-auto max-w-7xl px-4 py-10 sm:py-14">
                <section className="border-b border-slate-300 pb-10">
                    ...
                    <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">Aprende a compartir datos y acciones entre componentes sin perder un flujo predecible. Cada lección incluye documentación, ejemplo y un reto JSX editable.</p>
